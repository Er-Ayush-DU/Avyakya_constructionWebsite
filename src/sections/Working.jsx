                ...
                >
                    {
                        planning.map((item,index) =>(
                            <div key={index} className='flex flex-col justify-center items-center gap-5 border-2 border-yellow-300 rounded-md p-6'>
                                <div>
                                <item.icon className='size-[80px] bg-yellow-300 hover:bg-black hover:fill-white p-4 rounded-full cursor-pointer'/>
                                </div>
